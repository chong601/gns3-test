...
set interfaces dummy dum0 address 172.31.1.67/32
set interfaces ethernet eth0 address 172.31.1.7/31
set interfaces ethernet eth1 address 172.31.1.5/31
set interfaces ethernet eth6 address 172.31.1.133/27
set interfaces ethernet eth7 address 172.31.1.101/27

set protocols ospf parameters router-id 172.31.1.67
...
set protocols bgp parameters router-id 172.31.1.67
