...
set interfaces ethernet eth7 address 172.31.201.255/31
...
set protocols bgp neighbor 172.31.201.254 remote-as 64852
set protocols bgp neighbor 172.31.201.254 address-family ipv4-unicast
