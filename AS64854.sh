...
set interfaces ethernet eth2 address 172.31.210.7/31
...
set protocols bgp neighbor 172.31.210.6 remote-as 64500
set protocols bgp neighbor 172.31.210.6 address-family ipv4-unicast
