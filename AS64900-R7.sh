...
set interfaces ethernet eth4 address 172.31.202.3/31
set interfaces ethernet eth5 address 172.31.1.132/27
set interfaces ethernet eth6 address 172.31.203.1/31
...
set protocols bgp neighbor 172.31.202.2 remote-as 64853
set protocols bgp neighbor 172.31.202.2 address-family ipv4-unicast
set protocols bgp neighbor 172.31.203.0 remote-as 64854
set protocols bgp neighbor 172.31.203.0 address-family ipv4-unicast
