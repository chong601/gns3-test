...
set interfaces dummy dum0 address 172.31.1.66/32
set interfaces ethernet eth0 address 172.31.1.3/31
set interfaces ethernet eth1 address 172.31.1.4/31
set interfaces ethernet eth4 address 172.31.203.5/31
set interfaces ethernet eth5 address 172.31.1.132/27
set interfaces ethernet eth6 address 172.31.204.3/31
set interfaces ethernet eth7 address 172.31.1.100/27

set protocols ospf parameters router-id 172.31.1.66
...
set protocols bgp parameters router-id 172.31.1.66
...
set protocols bgp neighbor 172.31.203.4 remote-as 64853
set protocols bgp neighbor 172.31.203.4 address-family ipv4-unicast
set protocols bgp neighbor 172.31.204.2 remote-as 64854
set protocols bgp neighbor 172.31.204.2 address-family ipv4-unicast
...
set protocols bgp address-family ipv4-unicast network 172.31.22.0/24
set protocols static route 172.31.22.0/24 blackhole
