set system host-name AS64800-R1
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

set interfaces dummy dum0 address 172.31.0.64/32
set interfaces ethernet eth0 address 172.31.0.0/31
set interfaces ethernet eth1 address 172.31.0.2/31
set interfaces ethernet eth6 address 172.31.0.162/27
set interfaces ethernet eth7 address 172.31.0.98/27

set protocols ospf parameters router-id 172.31.0.64
...
set protocols bgp parameters router-id 172.31.0.64
...
set protocols bgp address-family ipv4-unicast network 172.31.10.0/24
set protocols static route 172.31.10.0/24 blackhole
