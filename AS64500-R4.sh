set system host-name AS64500-R4
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

set interfaces dummy dum0 address 172.31.210.3/32
set interfaces ethernet eth0 address 172.31.210.189/26
set interfaces ethernet eth1 address 172.31.210.190/26

set protocols ospf parameters router-id 172.31.210.3
...
set protocols bgp parameters router-id 172.31.210.3
