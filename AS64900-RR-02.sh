...
set interfaces dummy dum0 address 172.31.0.75/32
set interfaces ethernet eth0 address 172.31.0.41/31
set interfaces ethernet eth1 address 172.31.0.43/31
set interfaces ethernet eth7 address 172.31.0.193/27

set protocols ospf parameters router-id 172.31.0.75
...
set protocols bgp parameters router-id 172.31.0.75
