set system host-name AS64800-RR-01
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

set interfaces dummy dum0 address 172.31.0.72/32
set interfaces ethernet eth0 address 172.31.0.40/31
set interfaces ethernet eth1 address 172.31.0.42/31
set interfaces ethernet eth7 address 172.31.0.97/27

set protocols ospf parameters router-id 172.31.0.72
...
set protocols bgp parameters router-id 172.31.0.72
