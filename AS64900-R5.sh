...
set interfaces ethernet eth4 address 172.31.203.3/31
set interfaces ethernet eth5 address 172.31.1.130/27
set interfaces ethernet eth6 address 172.31.204.5/31
...
set protocols bgp neighbor 172.31.203.2 remote-as 64853
set protocols bgp neighbor 172.31.203.2 address-family ipv4-unicast
set protocols bgp neighbor 172.31.204.4 remote-as 64854
set protocols bgp neighbor 172.31.204.4 address-family ipv4-unicast
