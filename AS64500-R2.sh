set system host-name AS64500-R2
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

set interfaces dummy dum0 address 172.31.210.1/32
set interfaces ethernet eth0 address 172.31.210.130/26
set interfaces ethernet eth6 address 172.31.210.3/31
set interfaces ethernet eth7 address 172.31.210.6/31

set protocols ospf parameters router-id 172.31.210.1
...
set protocols bgp parameters router-id 172.31.210.1
...
set protocols bgp neighbor 172.31.210.7 remote-as 64854
set protocols bgp neighbor 172.31.210.7 address-family ipv4-unicast
...
set protocols bgp neighbor 172.31.210.129 remote-as 64500
set protocols bgp neighbor 172.31.210.129 passive
set protocols bgp neighbor 172.31.210.129 update-source dum0
set protocols bgp neighbor 172.31.210.129 address-family ipv4-unicast nexthop-self
